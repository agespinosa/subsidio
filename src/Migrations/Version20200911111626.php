 ...
 */
final class Version20200911111626 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TABLE requisito (id INT AUTO_INCREMENT NOT NULL, fecha_desde DATE NOT NULL, fecha_hasta DATE DEFAULT NULL, tipo_forma_pago VARCHAR(50) NOT NULL, file_excel_original_path VARCHAR(255) NOT NULL, file_excel_original_name VARCHAR(255) NOT NULL, file_subsidio_path VARCHAR(255) DEFAULT NULL, file_subsidio_name VARCHAR(255) DEFAULT NULL, motivo_pago VARCHAR(105) DEFAULT NULL, cuanta_origen_fodos VARCHAR(17) DEFAULT NULL, total_beneficiarios INT DEFAULT NULL, total_monto_pesos NUMERIC(23, 2) DEFAULT NULL, numero_archivo_pago INT DEFAULT NULL, numero_referencia_cliente_fila INT DEFAULT NULL, estado VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE subsidio_pago_proveedores (id INT AUTO_INCREMENT NOT NULL, cabecera_id INT DEFAULT NULL, requsito_id INT DEFAULT NULL, totales_id INT DEFAULT NULL, registro_id VARCHAR(2) DEFAULT NULL, tipo_pago VARCHAR(3) DEFAULT NULL, referencia_cliente VARCHAR(16) DEFAULT NULL, importe_apagar NUMERIC(13, 2) DEFAULT NULL, moneda_pago VARCHAR(3) DEFAULT NULL, fecha_ejecucion_pago DATE DEFAULT NULL, numero_proveedor VARCHAR(18) DEFAULT NULL, nombre_beneficiario VARCHAR(60) DEFAULT NULL, cuit VARCHAR(11) DEFAULT NULL, domicilio VARCHAR(120) DEFAULT NULL, localidad VARCHAR(35) DEFAULT NULL, codigo_postal VARCHAR(15) DEFAULT NULL, medio_comunicacion VARCHAR(150) DEFAULT NULL, banco VARCHAR(5) DEFAULT NULL, sucursal VARCHAR(35) DEFAULT NULL, tipo_cuenta VARCHAR(2) DEFAULT NULL, moneda_cuenta VARCHAR(3) DEFAULT NULL, numero_cuenta VARCHAR(22) DEFAULT NULL, forma_entrega_cheque VARCHAR(3) DEFAULT NULL, sucursal_prestador VARCHAR(8) DEFAULT NULL, moneda_cuenta_debito VARCHAR(3) DEFAULT NULL, cuenta_debito VARCHAR(17) DEFAULT NULL, motivo_pago VARCHAR(105) DEFAULT NULL, indicaciones_adicionales VARCHAR(80) DEFAULT NULL, requiere_recibo_impreso VARCHAR(1) DEFAULT NULL, con_recurso VARCHAR(1) DEFAULT NULL, numero_instrumento_pago VARCHAR(15) DEFAULT NULL, codigo_novedad_orden VARCHAR(3) DEFAULT NULL, cuenta_bancaria_beneficiario INT DEFAULT NULL, created_at DATETIME NOT NULL, updated_at DATETIME NOT NULL, INDEX IDX_2F82DCA9DE5DE1C (cabecera_id), INDEX IDX_2F82DCA9FD03F4D4 (requsito_id), INDEX IDX_2F82DCA95447FF96 (totales_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
